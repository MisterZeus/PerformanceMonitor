...
/// <summary>
/// Pins the SHARED connection-alert decision (<see cref="ConnectionAlertPolicy"/>, #1659) from Lite's suite —
/// mirrored in Darling.Tests, the AzureMasterFallback discipline for classes both apps depend on. The rules
