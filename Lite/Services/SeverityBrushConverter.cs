...
/// <summary>
/// Maps a <see cref="HealthSeverity"/> to Lite's frozen severity palette — the same four colours the
/// Darling viewer uses, so the two apps' AG tabs are visually identical. Exists so pre-banded models can live in
